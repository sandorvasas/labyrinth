// Copyright ( C ) 2006-2011 by Sándor Vasas
// Modified in 2011: namespace vsGL removed due to C usage

#ifndef __CRITEC_GLEXP_H__C_VERSION
#define __CRITEC_GLEXP_H__C_VERSION
